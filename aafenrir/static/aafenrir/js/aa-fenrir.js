/* global aaFenrirDefaultSettings, aaFenrirSettingsOverride, objectDeepMerge, bootstrap */

/**
 * Default settings for aa-fenrir
 * Settings can be overridden by defining aaFenrirSettingsOverride before this script is loaded.
 */
const aaFenrirSettings = (typeof aaFenrirSettingsOverride !== 'undefined')
    ? objectDeepMerge(aaFenrirDefaultSettings, aaFenrirSettingsOverride) // jshint ignore:line
    : aaFenrirDefaultSettings;
 ...
 * @param {string} [namespace=aa-fenrir] Namespace for the tooltip
 * @param {string} [trigger=hover] Trigger for the tooltip ('hover', 'click', etc.)
 * @returns {void}
 */
const _bootstrapTooltip = ({selector = 'body', namespace = 'aa-fenrir', trigger = 'hover'} = {}) => {
...
const _bootstrapPopOver = ({selector = 'body', namespace = 'aa-fenrir', trigger = 'hover'} = {}) => {
 ...
 * @param {string} [exportFileName='aa-fenrir.csv'] - The name of the exported CSV file.
 * @throws Will throw an error if the table is not a valid DataTables instance.
 * @returns {void}
 */
const _exportToCSV = (DataTable, exportFileName = 'aa-fenrir.csv') => {
