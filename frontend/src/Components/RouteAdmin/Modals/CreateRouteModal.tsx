        ...
        <div className="mt-4">
          ...
          <div>
            <Form.Label className={styles.routeLabel}>
              {t('Route Name / Corridor Description')} *
            </Form.Label>
            <Form.Control
              type="text"
              required
              ...
              placeholder="e.g. Jita 4-4 ⟷ 1DQ1-A Keepstar (Delve Express)"
          ...
          <div className={styles.modalBody + " mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4"}>
            <div>
              <Form.Label className={styles.routeLabel}>
                {t('Service Type')}
              </Form.Label>
              <Form.Select
                ...
                className={"mt-4 " + styles.ratesSelect}
              >
                <option value="jumpfreighter">Jump Freighter (JF)</option>
                <option value="freighter">Standard Freighter</option>
                <option value="deep_space_transport">Deep Space Transport (DST)</option>
              </Form.Select>
            </div>
            ...
            <div>
              ...
              >
                ...
                <option value="cyno_guarded">Cyno-Guarded</option>
              </Form.Select>
            </div>
            ...
            <div className="flex items-center gap-2 pt-6">
              ...
              />
              <Form.Label htmlFor="is-cyno-route-modal-chk" className="text-xs !text-slate-300">
